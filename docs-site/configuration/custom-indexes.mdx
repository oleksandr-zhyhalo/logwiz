...
Logwiz admins can also create indexes from the **Administration → Indexes → Create index** page. The page exposes the same Quickwit knobs covered below; advanced settings (retention, commit timeout) live behind an "Advanced" disclosure.
